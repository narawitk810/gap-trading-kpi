...
const DEPT_CONTEXT: Record<string, string> = {
  ...
  'บัญชี&การเงิน': 'บันทึกบัญชี, ตรวจสอบเอกสารการเงิน, จัดทำรายงาน, กระทบยอด',
  ...
  'Sales Admin': 'ดูแลลูกค้า, ติดตามออเดอร์, ประสานงานขาย, บันทึกยอด, ตอบแชท',
  'สต๊อค&จัดซื้อ': 'จัดการสินค้าคงคลัง, รับ-จ่ายสินค้า, ตรวจนับ stock, อัปเดตระบบ, จัดซื้อ',
