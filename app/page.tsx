          ...
          <div className="bg-white border border-[#E2E8F0] rounded-2xl overflow-hidden">
            ...
            <div className="px-4 pb-3 flex flex-wrap gap-2">
              {[
                ...
                { id: 'catramen', label: 'catramen card&boardgame' },
            ...
            {selectedStore && (
              <div className="border-t border-[#E2E8F0] px-4 py-3 flex flex-col gap-2">
                {(
                  ...
                  <a
                    key={sys.key}
                    href={storeLinks[sys.key]}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-3 bg-[#F5F6F8] hover:bg-[#1E3A5F]/10 rounded-xl px-3 py-2.5 transition-colors"
                  >
