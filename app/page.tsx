    ...
    <div className="min-h-screen bg-[#F5F6F8]">
      ...
      <div className="max-w-lg mx-auto px-4 py-6 space-y-5 pb-10">
        ...
        <div className="bg-white rounded-2xl p-4 shadow-sm space-y-4">
          <InputField label={(formData.department === 'ไลฟ์สด' || formData.department === 'Creative' || formData.department === 'การตลาด' || formData.department === 'Sales Admin' || formData.department === 'Store Retail' || formData.department === 'สต๊อค&จัดซื้อ' || formData.department === 'แพค') ? 'เลือกชื่อ (สิทธิพิเศษเริ่มใช้ 2570)' : 'ชื่อเล่น'} required error={errors.nickname}>
